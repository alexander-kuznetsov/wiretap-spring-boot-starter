...
`ch.qos.logback.access.spi` в `ch.qos.logback.access.common.spi`, и
один jar не покрывает все ветки 3.x. Подключайте координату, соответствующую
вашей версии Spring Boot. Boot 4.x запланирован отдельным major'ом
(wiretap 2.x) — политика deprecation и скрипты проверки в
