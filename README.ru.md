...
**Статус:** `1.0.0` — стабильный публичный релиз. Публичный API (конфигурационные свойства, SPI-интерфейсы, координаты артефактов) следует [семантическому версионированию](https://semver.org/lang/ru/).
...
Артефакты опубликованы в **Maven Central** — `mavenCentral()`, дефолтный
