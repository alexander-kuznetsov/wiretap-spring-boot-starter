...
class DefaultBodyParserTest {
    ...
    void structuralMasker_replacesNamedFields_onMatchingUrl() {
        ...
        assertThat(result.get("remaining_auth").asString()).isEqualTo("***");
        assertThat(result.get("remaining_cash").asString()).isEqualTo("***");
        assertThat(result.get("currency").asString()).isEqualTo("USD");
    }
    ...
    void structuralMasker_skipped_onNonMatchingUrl() {
        ...
        assertThat(result.get("remaining_auth").asString()).isEqualTo("1000");
    }
    ...
    void backwardCompatibility_singleArgConstructor() {
        ...
        assertThat(result.get("remaining_auth").asString()).isEqualTo("MASKED");
    }
}
