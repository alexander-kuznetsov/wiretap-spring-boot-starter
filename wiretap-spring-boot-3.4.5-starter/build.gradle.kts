...
// Wiretap built and tested against Spring Boot 3.4.5 (Logback 1.5 / logback-access
...
val targetSpringBootVersion = "3.4.5"
// 4.5.0 has parent spring-boot-starter-parent:3.4.2, so its bundled
// logback-access-common (2.0.6) is built against the Logback 1.5.x line that
// ships with SB 3.4.x. Newer starter lines (4.7.1) target SB 3.5+ and require
// logback-core APIs (AppenderDeclarationAnalyser) introduced after 1.5.18.
val targetLogbackAccessSpringVersion = "4.5.0"
val targetLogbackAccessCommonVersion = "2.0.6"
...
// Generated sources: clone root sources, swap the logback-access SPI package.
...
mavenPublishing {
    ...
    coordinates("io.github.alexander-kuznetsov", "wiretap-spring-boot-3.4.5-starter", project.version.toString())
    pom {
        name.set("Wiretap (Spring Boot 3.4.5)")
        description.set("Structured JSON logging for Spring Boot 3.4.5 — captures HTTP and Kafka traffic across all the standard clients. Pinned to the Logback 1.5 / logback-access common-API line; for Spring Boot 3.2 use wiretap-spring-boot-3.2.7-starter instead.")
